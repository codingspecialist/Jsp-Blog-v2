...
<html>
  ...
  <body>
  <%
    String clientId = "gGwbFCfN0mZEVYvFOvRB";//애플리케이션 클라이언트 아이디값";
    ...
    try {
      ...
      br.close();
      if(responseCode==200) {
        //out.println(res.toString()); //이 부분에서 화면에 JSON 출력
        Gson gson = new Gson();
        OAuthUser oAuthUser = 
        		gson.fromJson(res.toString(), OAuthUser.class);
        ...
        response.sendRedirect("navertest.jsp");
